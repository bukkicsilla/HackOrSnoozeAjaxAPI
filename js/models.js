...
class Story {
  ...
  getHostName() {
    //ADDED CODE
    //https://stackoverflow.com/questions/4815559/how-to-get-domain-name-from-url-using-jquery
    const hostname = $("<a>").prop("href", this.url).prop("hostname");
    return hostname;
  }
}
...
class StoryList {
  ...
  /** Remove story from API and remove from the story lists.
   *
